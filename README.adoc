...
NOTE: We have a team focused on **recruiting new value partners** into our ecosystem.  The partner is **fast-tracked** into our **Advanced Partner** tier by completing certain requirements.  This partners are **tasked with bringing Red Hat net new customers** and building net new bookings.
